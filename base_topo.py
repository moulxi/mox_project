...
ap1 = mox.Application(buf = s1_buf1, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)
ap2 = mox.Application(buf = s1_buf2, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)


# application1 and its buffer 
a1_buf = mox.Buffer(pack_num = 70, capacity = 100, name = "a1_buf")
a1 = mox.Application(buf = a1_buf, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)


# application2 and its buffer
a2_buf = mox.Buffer(pack_num = 50, capacity = 100, name = "a2_buf")
a2 = mox.Application(buf = a2_buf, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)
...
thread_s1 = threading.Thread(target=s1.ready, args=("fifo",200))
