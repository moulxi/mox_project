...
s1_buf1 = mox.Buffer(pack_num = 50, capacity = 80, name = "s1_buf1")
s1_buf2 = mox.Buffer(pack_num = 20, capacity = 100, name = "s1_buf2")
s1 = mox.Switch(buf_list = [s1_buf1, s1_buf2], pkt_loc = 2, time_loc = 50)

# the application which put packet into switch1
ap1 = mox.Application(app_buf = s1_buf1, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)
ap2 = mox.Application(app_buf = s1_buf2, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)


# application1 and its buffer 
a1_buf = mox.Buffer(pack_num = 70, capacity = 100, name = "a1_buf")
a1 = mox.Application(app_buf = a1_buf, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)


# application2 and its buffer
a2_buf = mox.Buffer(pack_num = 50, capacity = 100, name = "a2_buf")
a2 = mox.Application(app_buf = a2_buf, time_loc = 50, time_scale = 0, pkt_loc = 1, pkt_scale = 0)
